...
Module['FS_createPath']("/assets", "machines", true, true);
   ...
   loadPackage({"files": [{"filename": "/assets/board.png", "start": 0, "end": 56679, "audio": 0}, {"filename": "/assets/belts/belt_d.png", "start": 56679, "end": 73218, "audio": 0}, {"filename": "/assets/belts/belt_l.png", "start": 73218, "end": 87157, "audio": 0}, {"filename": "/assets/belts/belt_r.png", "start": 87157, "end": 101011, "audio": 0}, {"filename": "/assets/belts/belt_ss.png", "start": 101011, "end": 316204, "audio": 0}, {"filename": "/assets/belts/belt_u.png", "start": 316204, "end": 329778, "audio": 0}, {"filename": "/assets/cubes/cube_blue.png", "start": 329778, "end": 346990, "audio": 0}, {"filename": "/assets/cubes/cube_green.png", "start": 346990, "end": 365126, "audio": 0}, {"filename": "/assets/cubes/cube_red.png", "start": 365126, "end": 382527, "audio": 0}, {"filename": "/assets/cubes/cube_violet.png", "start": 382527, "end": 401156, "audio": 0}, {"filename": "/assets/cubes/cube_white.png", "start": 401156, "end": 413625, "audio": 0}, {"filename": "/assets/cubes/cube_yellow.png", "start": 413625, "end": 431247, "audio": 0}, {"filename": "/assets/machines/upgrader_d.png", "start": 431247, "end": 445665, "audio": 0}, {"filename": "/assets/machines/upgrader_l.png", "start": 445665, "end": 460039, "audio": 0}, {"filename": "/assets/machines/upgrader_r.png", "start": 460039, "end": 474390, "audio": 0}, {"filename": "/assets/machines/upgrader_u.png", "start": 474390, "end": 488695, "audio": 0}], "remote_package_size": 488695, "package_uuid": "487441d9-9aca-4e42-87ac-089f3101b8b1"});
...
var ASM_CONSTS = {
  61777: function($0, $1, $2) {var w = $0; var h = $1; var pixels = $2; if (!Module['SDL2']) Module['SDL2'] = {}; var SDL2 = Module['SDL2']; if (SDL2.ctxCanvas !== Module['canvas']) { SDL2.ctx = Module['createContext'](Module['canvas'], false, true); SDL2.ctxCanvas = Module['canvas']; } if (SDL2.w !== w || SDL2.h !== h || SDL2.imageCtx !== SDL2.ctx) { SDL2.image = SDL2.ctx.createImageData(w, h); SDL2.w = w; SDL2.h = h; SDL2.imageCtx = SDL2.ctx; } var data = SDL2.image.data; var src = pixels >> 2; var dst = 0; var num; if (typeof CanvasPixelArray !== 'undefined' && data instanceof CanvasPixelArray) { num = data.length; while (dst < num) { var val = HEAP32[src]; data[dst ] = val & 0xff; data[dst+1] = (val >> 8) & 0xff; data[dst+2] = (val >> 16) & 0xff; data[dst+3] = 0xff; src++; dst += 4; } } else { if (SDL2.data32Data !== data) { SDL2.data32 = new Int32Array(data.buffer); SDL2.data8 = new Uint8Array(data.buffer); } var data32 = SDL2.data32; num = data32.length; data32.set(HEAP32.subarray(src, src + num)); var data8 = SDL2.data8; var i = 3; var j = i + 4*num; if (num % 8 == 0) { while (i < j) { data8[i] = 0xff; i = i + 4 | 0; data8[i] = 0xff; i = i + 4 | 0; data8[i] = 0xff; i = i + 4 | 0; data8[i] = 0xff; i = i + 4 | 0; data8[i] = 0xff; i = i + 4 | 0; data8[i] = 0xff; i = i + 4 | 0; data8[i] = 0xff; i = i + 4 | 0; data8[i] = 0xff; i = i + 4 | 0; } } else { while (i < j) { data8[i] = 0xff; i = i + 4 | 0; } } } SDL2.ctx.putImageData(SDL2.image, 0, 0); return 0;},  
 63232: function($0, $1, $2, $3, $4) {var w = $0; var h = $1; var hot_x = $2; var hot_y = $3; var pixels = $4; var canvas = document.createElement("canvas"); canvas.width = w; canvas.height = h; var ctx = canvas.getContext("2d"); var image = ctx.createImageData(w, h); var data = image.data; var src = pixels >> 2; var dst = 0; var num; if (typeof CanvasPixelArray !== 'undefined' && data instanceof CanvasPixelArray) { num = data.length; while (dst < num) { var val = HEAP32[src]; data[dst ] = val & 0xff; data[dst+1] = (val >> 8) & 0xff; data[dst+2] = (val >> 16) & 0xff; data[dst+3] = (val >> 24) & 0xff; src++; dst += 4; } } else { var data32 = new Int32Array(data.buffer); num = data32.length; data32.set(HEAP32.subarray(src, src + num)); } ctx.putImageData(image, 0, 0); var url = hot_x === 0 && hot_y === 0 ? "url(" + canvas.toDataURL() + "), auto" : "url(" + canvas.toDataURL() + ") " + hot_x + " " + hot_y + ", auto"; var urlBuf = _malloc(url.length + 1); stringToUTF8(url, urlBuf, url.length + 1); return urlBuf;},  
 64221: function($0) {if (Module['canvas']) { Module['canvas'].style['cursor'] = UTF8ToString($0); } return 0;},  
 64314: function() {if (Module['canvas']) { Module['canvas'].style['cursor'] = 'none'; }},  
 64383: function() {return screen.width;},  
 64408: function() {return screen.height;},  
 64434: function() {return window.innerWidth;},  
 64464: function() {return window.innerHeight;},  
 64495: function($0) {if (typeof setWindowTitle !== 'undefined') { setWindowTitle(UTF8ToString($0)); } return 0;},  
 64590: function() {if (typeof(AudioContext) !== 'undefined') { return 1; } else if (typeof(webkitAudioContext) !== 'undefined') { return 1; } return 0;},  
 64727: function() {if ((typeof(navigator.mediaDevices) !== 'undefined') && (typeof(navigator.mediaDevices.getUserMedia) !== 'undefined')) { return 1; } else if (typeof(navigator.webkitGetUserMedia) !== 'undefined') { return 1; } return 0;},  
