...
Module['FS_createPath']("/assets", "machines", true, true);
   ...
   loadPackage({"files": [{"filename": "/assets/belts/belt_d.png", "start": 0, "end": 16539, "audio": 0}, {"filename": "/assets/belts/belt_l.png", "start": 16539, "end": 30478, "audio": 0}, {"filename": "/assets/belts/belt_r.png", "start": 30478, "end": 44332, "audio": 0}, {"filename": "/assets/belts/belt_ss.png", "start": 44332, "end": 259525, "audio": 0}, {"filename": "/assets/belts/belt_u.png", "start": 259525, "end": 273099, "audio": 0}, {"filename": "/assets/cubes/cube_blue.png", "start": 273099, "end": 290311, "audio": 0}, {"filename": "/assets/cubes/cube_green.png", "start": 290311, "end": 308447, "audio": 0}, {"filename": "/assets/cubes/cube_red.png", "start": 308447, "end": 325848, "audio": 0}, {"filename": "/assets/cubes/cube_violet.png", "start": 325848, "end": 344477, "audio": 0}, {"filename": "/assets/cubes/cube_white.png", "start": 344477, "end": 356946, "audio": 0}, {"filename": "/assets/cubes/cube_yellow.png", "start": 356946, "end": 374568, "audio": 0}, {"filename": "/assets/machines/upgrader_d.png", "start": 374568, "end": 388986, "audio": 0}, {"filename": "/assets/machines/upgrader_l.png", "start": 388986, "end": 403360, "audio": 0}, {"filename": "/assets/machines/upgrader_r.png", "start": 403360, "end": 417711, "audio": 0}, {"filename": "/assets/machines/upgrader_u.png", "start": 417711, "end": 432016, "audio": 0}], "remote_package_size": 432016, "package_uuid": "0f9b246d-ab0a-4002-9c19-64efecd20d5c"});
...
var ASM_CONSTS = {
  61809: function($0, $1, $2) {var w = $0; var h = $1; var pixels = $2; if (!Module['SDL2']) Module['SDL2'] = {}; var SDL2 = Module['SDL2']; if (SDL2.ctxCanvas !== Module['canvas']) { SDL2.ctx = Module['createContext'](Module['canvas'], false, true); SDL2.ctxCanvas = Module['canvas']; } if (SDL2.w !== w || SDL2.h !== h || SDL2.imageCtx !== SDL2.ctx) { SDL2.image = SDL2.ctx.createImageData(w, h); SDL2.w = w; SDL2.h = h; SDL2.imageCtx = SDL2.ctx; } var data = SDL2.image.data; var src = pixels >> 2; var dst = 0; var num; if (typeof CanvasPixelArray !== 'undefined' && data instanceof CanvasPixelArray) { num = data.length; while (dst < num) { var val = HEAP32[src]; data[dst ] = val & 0xff; data[dst+1] = (val >> 8) & 0xff; data[dst+2] = (val >> 16) & 0xff; data[dst+3] = 0xff; src++; dst += 4; } } else { if (SDL2.data32Data !== data) { SDL2.data32 = new Int32Array(data.buffer); SDL2.data8 = new Uint8Array(data.buffer); } var data32 = SDL2.data32; num = data32.length; data32.set(HEAP32.subarray(src, src + num)); var data8 = SDL2.data8; var i = 3; var j = i + 4*num; if (num % 8 == 0) { while (i < j) { data8[i] = 0xff; i = i + 4 | 0; data8[i] = 0xff; i = i + 4 | 0; data8[i] = 0xff; i = i + 4 | 0; data8[i] = 0xff; i = i + 4 | 0; data8[i] = 0xff; i = i + 4 | 0; data8[i] = 0xff; i = i + 4 | 0; data8[i] = 0xff; i = i + 4 | 0; data8[i] = 0xff; i = i + 4 | 0; } } else { while (i < j) { data8[i] = 0xff; i = i + 4 | 0; } } } SDL2.ctx.putImageData(SDL2.image, 0, 0); return 0;},  
 63264: function($0, $1, $2, $3, $4) {var w = $0; var h = $1; var hot_x = $2; var hot_y = $3; var pixels = $4; var canvas = document.createElement("canvas"); canvas.width = w; canvas.height = h; var ctx = canvas.getContext("2d"); var image = ctx.createImageData(w, h); var data = image.data; var src = pixels >> 2; var dst = 0; var num; if (typeof CanvasPixelArray !== 'undefined' && data instanceof CanvasPixelArray) { num = data.length; while (dst < num) { var val = HEAP32[src]; data[dst ] = val & 0xff; data[dst+1] = (val >> 8) & 0xff; data[dst+2] = (val >> 16) & 0xff; data[dst+3] = (val >> 24) & 0xff; src++; dst += 4; } } else { var data32 = new Int32Array(data.buffer); num = data32.length; data32.set(HEAP32.subarray(src, src + num)); } ctx.putImageData(image, 0, 0); var url = hot_x === 0 && hot_y === 0 ? "url(" + canvas.toDataURL() + "), auto" : "url(" + canvas.toDataURL() + ") " + hot_x + " " + hot_y + ", auto"; var urlBuf = _malloc(url.length + 1); stringToUTF8(url, urlBuf, url.length + 1); return urlBuf;},  
 64253: function($0) {if (Module['canvas']) { Module['canvas'].style['cursor'] = UTF8ToString($0); } return 0;},  
 64346: function() {if (Module['canvas']) { Module['canvas'].style['cursor'] = 'none'; }},  
 64415: function() {return screen.width;},  
 64440: function() {return screen.height;},  
 64466: function() {return window.innerWidth;},  
 64496: function() {return window.innerHeight;},  
 64527: function($0) {if (typeof setWindowTitle !== 'undefined') { setWindowTitle(UTF8ToString($0)); } return 0;},  
 64622: function() {if (typeof(AudioContext) !== 'undefined') { return 1; } else if (typeof(webkitAudioContext) !== 'undefined') { return 1; } return 0;},  
 64759: function() {if ((typeof(navigator.mediaDevices) !== 'undefined') && (typeof(navigator.mediaDevices.getUserMedia) !== 'undefined')) { return 1; } else if (typeof(navigator.webkitGetUserMedia) !== 'undefined') { return 1; } return 0;},  
